//Вариант №21.
//Построить два списка из целых чисел, вводимых с клавиатуры: список L1 и список L2. 
//На основе списков L1 и L2 образовать список L3 из чисел, которые входят как в список L1, так и в список L2. 
